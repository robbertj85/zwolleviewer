...
export function buildZwolleLayers(city: CityConfig): DataSource[] {
  ...
  return [
    ...
    {
      id: "bodem-onderzoeken",
      labelProperties: ["ONDERZOEKSOORT", "NAAM"],
      name: "Bodemonderzoeken",
      endpoint: "gisservices.zwolle.nl/ArcGIS/rest/services/Bodem/MapServer/4",
      source: "Gemeente Zwolle GIS",
      description: "Uitgevoerde bodemonderzoeken met onderzoeksoort, hypothese en eindoordeel (WBB-toetsing grond en grondwater)",
      category: "bodem-ondergrond",
      bog: true,
      isNew: true,
      color: [150, 110, 50, 100],
      icon: "FileSearch",
      visible: false,
      loading: false,
      filled: true,
      ...
      lineWidth: 1,
      defaultLimit: 2000,
      fetchData: async (full) => fzg("Bodem", 4, "MapServer", 2000, full),
    },
    {
      id: "bodem-nazorg",
      labelProperties: ["CONTOURTYPE", "LOCATIECODE"],
      name: "Bodem Nazorg- en Zorgmaatregelen",
      endpoint: "gisservices.zwolle.nl/ArcGIS/rest/services/Bodem/MapServer/0",
      source: "Gemeente Zwolle GIS",
      description: "Locaties met nazorg- en zorgmaatregelen na bodemsanering (incl. einddatum nazorg)",
      category: "bodem-ondergrond",
      bog: true,
      isNew: true,
      color: [120, 90, 40, 130],
      ...
      lineWidth: 1,
      defaultLimit: 2000,
      fetchData: async (full) => fzg("Bodem", 0, "MapServer", 2000, full),
    },

    // ═══════════════════════════════════════
    // RIOLERING — DRUKRIOLERING, DRAINAGE & STROOMRICHTING (BOG)
    // ═══════════════════════════════════════
    {
      id: "riolering-drukpersleiding",
      labelProperties: ["TYPE", "LAAGNAAM"],
      name: "Druk-/Persleidingen Riolering",
      endpoint: "gisservices.zwolle.nl/ArcGIS/rest/services/Riolering_openbaar/FeatureServer/13",
      source: "Gemeente Zwolle GIS",
      description: "Ondergrondse druk- en persleidingen van het rioolstelsel",
      category: "bodem-ondergrond",
      bog: true,
      isNew: true,
      color: [150, 80, 50, 200],
      ...
      lineWidth: 2,
      defaultLimit: 2000,
      fetchData: async (full) => fzg("Riolering_openbaar", 13, "FeatureServer", 2000, full),
    },
    {
      id: "riolering-drainage",
      labelProperties: ["LAAG"],
      name: "Drainage Riolering",
      endpoint: "gisservices.zwolle.nl/ArcGIS/rest/services/Riolering_openbaar/FeatureServer/17",
      source: "Gemeente Zwolle GIS",
      description: "Ondergrondse drainageleidingen voor grondwaterbeheersing",
      category: "bodem-ondergrond",
      bog: true,
      isNew: true,
      color: [120, 150, 90, 180],
      icon: "Route",
      visible: false,
      loading: false,
      filled: false,
      ...
      lineWidth: 1,
      defaultLimit: 2000,
      fetchData: async (full) => fzg("Riolering_openbaar", 17, "FeatureServer", 2000, full),
    },
    {
      id: "riolering-stroomrichting",
      labelProperties: ["LEIDINGTYPE", "LEIDINGTOELICHTING"],
      name: "Riolering Stroomrichting",
      endpoint: "gisservices.zwolle.nl/ArcGIS/rest/services/Riolering_openbaar/FeatureServer/25",
      source: "Gemeente Zwolle GIS",
      description: "Stroomrichtingspunten van het rioolstelsel per leidingtype (vuilwater, gemengd, hemelwater)",
      category: "bodem-ondergrond",
      bog: true,
      isNew: true,
      color: [170, 120, 70, 180],
      icon: "ArrowRight",
      visible: false,
      loading: false,
      pointType: "scatterplot",
      radius: 3,
      defaultLimit: 2000,
      fetchData: async (full) => fzg("Riolering_openbaar", 25, "FeatureServer", 2000, full),
      colorMap: {
        property: "LEIDINGTYPE",
        values: {
          "Vuilwaterriool": [140, 90, 50, 180],
          "Gemengd riool": [150, 120, 70, 180],
          "Hemelwaterriool": [60, 140, 200, 180],
        },
        default: [170, 120, 70, 180],
      },
    },

    // ═══════════════════════════════════════
    // ENEXIS — ONDERGRONDSE TECHNISCHE GEBOUWEN (BOG)
    // ═══════════════════════════════════════
    {
      id: "enexis-gas-stations-lagedruk",
      labelProperties: ["OMSCHRIJVING"],
      name: "Enexis Gasstations (lage druk)",
      endpoint: "gisservices.zwolle.nl/ArcGIS/rest/services/Energie_in_Beeld_Enexis_Assets/MapServer/2",
      source: "Gemeente Zwolle GIS / Enexis",
      description: "Technische gebouwen gas (lage druk) van het Enexis-net",
      category: "bodem-ondergrond",
      bog: true,
      isNew: true,
      color: [220, 180, 60, 200],
      icon: "Flame",
      visible: false,
      loading: false,
      pointType: "scatterplot",
      radius: 4,
      defaultLimit: 2000,
      fetchData: async (full) => fzg("Energie_in_Beeld_Enexis_Assets", 2, "MapServer", 2000, full),
    },
    {
      id: "enexis-elektra-stations-laagspanning",
      labelProperties: ["OMSCHRIJVING"],
      name: "Enexis Elektrastations (laagspanning)",
      endpoint: "gisservices.zwolle.nl/ArcGIS/rest/services/Energie_in_Beeld_Enexis_Assets/MapServer/6",
      source: "Gemeente Zwolle GIS / Enexis",
      description: "Technische gebouwen elektra (laagspanning) van het Enexis-net",
      category: "bodem-ondergrond",
      bog: true,
      isNew: true,
      ...
      radius: 4,
      defaultLimit: 2000,
      fetchData: async (full) => fzg("Energie_in_Beeld_Enexis_Assets", 6, "MapServer", 2000, full),
    },
